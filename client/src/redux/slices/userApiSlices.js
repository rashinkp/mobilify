...
export const usersApiSlice = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getOtpTimeRemaining: builder.query({
      query: (userId) => ({
        url: `${USERS_URL}/otpTimeRemaining/${userId}`,
        method: 'GET',
      }),
    }),
    getOtpTimeRemainingByEmail: builder.query({
      query: () => ({
        url: `${USERS_URL}/otpTimeRemainingEmail`,
        method: 'GET',
      }),
    }),
  }),
