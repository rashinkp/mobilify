...
import {resendOTP, resendOtpEamil, sendOTP, sendOTPToEmail, verifyOtp, getOtpTimeRemaining, getOtpTimeRemainingByEmail} from "../controllers/otpController.js";
...
router.get("/otpTimeRemaining/:id", getOtpTimeRemaining);
router.get("/otpTimeRemainingEmail", getOtpTimeRemainingByEmail);
